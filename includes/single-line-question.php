	<div class="well well-sm edit-box-single-line-question">
		<div class="row">
			<div class="col-xs-2">
			...
			<div class="col-xs-10">
				<div class="form">
					<div class="form-group">
						<label class="field-label" for="field-1">Single Line Text Question</label>
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="home">
							<div class="form-group">
								...
								<input type="name" class="form-control field-label" placeholder="Single Line Text Question"/>
							</div>
