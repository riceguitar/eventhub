			...
			<div class="col-xs-10">
				<div class="form-inline">
					<div class="form-group">
						...
						<input type="checkbox" class="form-control"><label class="inline">Option 1</label><br>
						<input type="checkbox" class="form-control"><label class="inline">Option 2</label>
					</div>
				</div>
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="home">
							<div class="form-group">
								...
								<input type="text" class="form-control field-label" placeholder="Checkbox"/>
							</div>
							<div class="form-group">
								<label for="field-1">Checkbox Options</label>
