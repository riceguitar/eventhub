	<div class="well well-sm edit-box-telephone">
		<div class="row">
			<div class="col-xs-2">
			...
			<div class="col-xs-10">
				<div class="form-inline">
					<div class="form-group">
						<label class="field-label" for="field-1">Phone Number</label>
						<input type="name" class="form-control" placeholder="(XXX) XXX-XXXX"/>
					</div>
				</div>
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="home">
							<div class="form-group">
								...
								<input type="name" class="form-control field-label" placeholder="Phone Number"/>
							</div>
